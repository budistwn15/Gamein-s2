...
import com.budi.setiawan.core.databinding.ItemFavoriteBinding
...
class FavoriteAdapter : RecyclerView.Adapter<FavoriteAdapter.ListViewHolder>() {
    ...
    inner class ListViewHolder(private val binding: ItemFavoriteBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(data: Game){
            with(binding){
